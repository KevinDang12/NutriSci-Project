...
public class DecreaseCalorieStrategy implements FoodSwapStrategy {

    double calorieReductionTarget;
    double minProteinMaintenance = 0.95;
    double minFiberMaintenance = 1.0;
    int maxCaloriesPerSwap = 200;
